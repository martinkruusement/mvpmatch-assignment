<template>
  <div>
    ...
    <p>This Site is controlled, operated and administered by us from our office in Tallinn, Estonia. We make no representation that materials at this site are appropriate or available for use at other locations outside of the Estonia and access to them from territories where their contents are illegal is prohibited. If you access this Site from a location outside of the Estonia, you are responsible for compliance with all local laws.</p>
    <h2>12. GENERAL</h2>
